                            ...
                            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                                ...
                                <div class="flex flex-col gap-2 lg:items-end">
                                    ...
                                    @if(in_array($req->status, ['bac_evaluation','bac_approved']))
                                        <a href="{{ route('supply.purchase-orders.create', $req) }}" class="inline-flex items-center justify-center px-4 py-2 bg-cagsu-maroon text-white rounded-lg hover:bg-cagsu-orange transition">
                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
