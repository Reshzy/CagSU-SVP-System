                            ...
                            @if($validation['can_generate'])
                                <div class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-4">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-semibold">{{ $aoqGeneration ? 'Ready to Regenerate AOQ' : 'Ready to Generate AOQ' }}</span>
                                    </div>
                                    <p class="mt-2 text-sm">All items have been evaluated and all ties have been resolved.</p>
                                    @if($aoqGeneration)
                                        <p class="mt-1 text-sm text-green-600">Regenerate if the winner changed or a supplier withdrew. No Purchase Order may be created for this group yet.</p>
                                    @endif
                                </div>
                                ...
                                <button type="button" 
                                    ...
                                    {{ $aoqGeneration ? 'Regenerate AOQ for ' . $group->group_name : 'Generate AOQ for ' . $group->group_name }}
                                </button>
                            @else
