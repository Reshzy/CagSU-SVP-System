        ...
        <div class="px-6 py-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                @if (config('dev-tools.enabled'))
                    <a href="{{ route('dev-tools.index') }}" class="border border-amber-200 rounded-lg p-4 hover:bg-amber-50 block">
                        <div class="flex items-center">
                            <svg class="h-6 w-6 text-amber-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" />
                            </svg>
                            <div>
                                <h4 class="font-medium text-gray-900">Dev Tools</h4>
                                <p class="text-sm text-gray-500">Create test PRs, budgets, PPMPs, workflow jumps</p>
                            </div>
                        </div>
                    </a>
                @endif
