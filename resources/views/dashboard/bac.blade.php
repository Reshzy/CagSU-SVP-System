...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
    ...
    <div class="bg-white overflow-hidden shadow-lg rounded-lg">
            ...
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <svg class="h-8 w-8 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 4h6m-6 4h6"></path>
                    </svg>
                </div>
        ...
        <div class="bg-gray-50 px-6 py-3">
            <div class="text-sm">
                <a href="{{ route('bac.quotations.index') }}" class="font-medium text-cagsu-maroon hover:text-cagsu-orange">Review requests</a>
            </div>
        </div>
    </div>
...
<div class="bg-white shadow rounded-lg mb-6">
    <div class="px-6 py-4 border-b border-gray-200">
        <h3 class="text-lg leading-6 font-medium text-gray-900">BAC Evaluation Workflow</h3>
    </div>
    <div class="px-6 py-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="text-center p-4 border border-gray-200 rounded-lg">
                <svg class="h-8 w-8 text-cagsu-maroon mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-center p-4 border border-gray-200 rounded-lg">
                <svg class="h-8 w-8 text-cagsu-orange mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<!-- Quick Actions for BAC Chair/Admin -->
